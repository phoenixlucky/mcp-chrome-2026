...
if (Symbol.dispose) SIMDMath.prototype[Symbol.dispose] = SIMDMath.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./simd_math_bg.js": import0,
    };
}

const SIMDMathFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_simdmath_free(ptr, 1));
