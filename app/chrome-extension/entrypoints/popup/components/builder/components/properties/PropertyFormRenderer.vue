...
/* eslint-disable vue/no-mutating-props -- Node is a reactive builder-store object; edits must persist in-place. */
...
function resolveField(field: FieldSpec): Component {
