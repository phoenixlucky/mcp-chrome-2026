...
> **主题背景全面适配** — 新立绘铺满 Popup / Sidepanel / Welcome / Builder。
>
> - 🎨 **Popup 非首页高级背景** — MCP 工具页、本地模型页叠加猫娘立绘背景 + 半透明毛玻璃卡片
> - 🖼️ **Sidepanel 全幅背景** — 侧边栏启用猫娘高级立绘封面，主题背景让位
> - 💎 **Welcome 半透明卡片** — 卡片与命令区块改为 `color-mix` 半透明材质，与封面背景融为一体
> - 📐 **构图修正** — Builder Canvas 与 Popup 首页背景改 `center top`，头部视觉不再被裁切
> - 🔧 版本统一为 v2.4.4
