...
> **猫娘主题焕新 + 安装体验优化** — 全新图标与背景，依赖升级免编译。
>
> - 🎨 **主题素材全面更新** — 全套扩展图标（16–128px）、聊天背景与高级立绘更换为新作，Welcome 页新增专属背景并改为全幅封面布局
> - 📦 **`better-sqlite3` 升级 v13** — 迁移到 N-API 预编译二进制，安装无需源码编译与 Node headers 下载，`--allow-scripts` 白名单同步精简
> - 🔧 版本统一为 v2.4.3
