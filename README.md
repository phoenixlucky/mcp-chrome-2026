...
> **代理轮换工具 + 英文工具描述** — 工具元数据与代理能力升级。
>
> - 🔄 **`chrome_proxy_rotate` 工具** — 标签页异常时轮换代理会话并重新加载页面（不泄露账号密码）
> - 🌐 **英文工具描述** — 新增 `tools-en.ts` 全量英文元数据，中英双语完整覆盖
> - 📜 **Scroll 工具增强** — 元素滚动、方向控制、超时处理等能力扩展
> - ⚡ **Web Editor 性能监控更新** — `perf-monitor` 增强
> - 🔧 版本统一为 v1.8.0
